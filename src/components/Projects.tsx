...
const projects: Project[] = [
  {
    ...
    description: "Application de gestion des animaux, des enclos et du personnel d'un zoo permettant d'optimiser les opérations quotidiennes.",
    image: "https://images.unsplash.com/photo-1503919545889-aef636e10ad4?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80",
    technologies: ["C#", "SQL", "WPF"],
    githubUrl: "http://bemba942.github.io/projet/",
  },
  {
    id: 2,
    title: "Gestion d'Activités",
    description: "Système de gestion des activités permettant de planifier, suivre et gérer efficacement différentes activités et événements.",
